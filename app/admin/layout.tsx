...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-dnp-black text-white overflow-hidden">
      ...
      {/* ── Topbar único — logo + breadcrumb + busca numa única linha, full width ── */}
      <header className="shrink-0 h-[62px] bg-dnp-dark border-b border-dnp-border flex items-stretch z-10">

        {/* Logo — largura igual à sidebar */}
        <div className="hidden md:flex items-center gap-2.5 px-5 w-[236px] shrink-0">
        ...
        <div className="flex items-center px-7 flex-1 min-w-0">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <aside className="hidden md:flex flex-col w-[236px] shrink-0 bg-dnp-dark">
